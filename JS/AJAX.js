...
function GetData() {
    ...
    Graf_NR++;
    //$(".connection .status").html('<span class="on">Graf complet</span>');
    //html_txt="";
    }
    else if(Graf_NR===21){
...
success: function (result) {
    ...
    //console.log('AjaxSendTime:  '+AjaxSendTime);
    //console.log('AjaxReciveTime:'+AjaxReciveTime);
...
/*$('.NR2').css( "height", "255px" ); 5 - 255 = 250 */
